...
import test.model.domain.jakarta.JakartaBaseEntity;
import test.model.domain.jakarta.JakartaCustomer;
...
public class CustomerEntityJakartaTest extends BaseTest {
